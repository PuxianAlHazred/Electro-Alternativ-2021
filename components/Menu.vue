    ...
    <transition name="page_transition" mode="in-out"
      ...
      <div v-show="menu" class="content-menu">
          <ul class="list">
              ...
              <li class="list-item">
                <a target="_blank" href="https://regarts.festik.net/electro-alternativ-pass-festival/1?fbclid=IwAR2tg94MrwuBFe0IJpT8orGscYvdC6QPKqt2CzgEEoHHDTuWqw_WCYNcWqA"><h4>BILLETTERIE</h4></a>
              </li>
              <li class="list-item">
